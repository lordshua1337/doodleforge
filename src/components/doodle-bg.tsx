...
// Kid art doodles scattered across dark gallery walls.
// Low-opacity crayon-style SVGs that give the "museum with kid art" vibe.
// Fixed-position, non-interactive.

const DOODLES = [
  // Star (top-left)
  {
    top: "8%", left: "5%", rotate: 12, opacity: 0.04, color: "#FBBF24",
  ...
  // Heart (mid-right)
  {
    top: "45%", left: "92%", rotate: 15, opacity: 0.035, color: "#F472B6",
  ...
  // Spiral (bottom-left)
  {
    top: "72%", left: "6%", rotate: -10, opacity: 0.03, color: "#A78BFA",
  ...
  // Zigzag (bottom-right)
  {
    top: "80%", left: "90%", rotate: 25, opacity: 0.03, color: "#60A5FA",
  ...
  // Cloud (center-top)
  {
    top: "5%", left: "50%", rotate: 0, opacity: 0.025, color: "#60A5FA",
  ...
  {
    top: "88%", left: "45%", rotate: 20, opacity: 0.03, color: "#34D399",
